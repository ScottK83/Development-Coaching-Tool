...
// GLOBAL STATE
// ============================================
const APP_VERSION = '2026.03.20.33'; // Version: YYYY.MM.DD.NN
 ...
 * This prevents doubled cumulative metrics (reliability, calls, etc.)
 */
function cleanupStaleAutoYtds() {
    try {
        ...
        years.forEach(year => {
            ...
            if (!anchor) return; // no real YTD for this year, keep auto
            // Remove all auto-generated YTDs for this year
            Object.keys(ytdData).forEach(key => {
...
function getLatestYearPeriodForEmployee(employeeName, reviewYear) {
    ...
    candidates.sort((a, b) => {
        // Compare priority tiers first (real YTD > auto YTD > non-YTD)
