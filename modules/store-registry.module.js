...
(function () {
    ...
    const STORES = [
        ...
        { name: 'employeeNicknames', tier: 'data', backend: 'local', merge: 'lastWriterWins' },
        { name: 'employeeSupervisors', tier: 'data', backend: 'local', merge: 'lastWriterWins' },
        { name: 'executiveSummaryNotes', tier: 'data', backend: 'local', merge: 'lastWriterWins' },
        { name: 'userCustomTips', tier: 'data', backend: 'local', merge: 'lastWriterWins' },
        { name: 'coachingTips', tier: 'data', backend: 'local', merge: 'lastWriterWins' },
        { name: 'customMetrics', tier: 'data', backend: 'local', merge: 'lastWriterWins' },
        { name: 'modifiedServerTips', tier: 'data', backend: 'local', merge: 'lastWriterWins' },
