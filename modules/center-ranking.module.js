(function () {
    ...
    function buildCenterRankings() {
        ...
        // Check YTD data (skip auto-generated YTDs — they can have aggregation errors)
        Object.entries(yData).forEach(function (entry) {
            if (entry[1]?.metadata?.autoGeneratedYtd) return;
        ...
        // Find the single newest REAL (non-auto-generated) YTD for the current year.
        // Auto-generated YTDs are aggregations that can have bad data — skip them.
        var newestYtdPeriod = null;
        var newestYtdEndTime = 0;
        Object.entries(yData).forEach(function (entry) {
            var meta = entry[1]?.metadata || {};
            if (meta.autoGeneratedYtd) return; // Skip auto-generated YTDs
