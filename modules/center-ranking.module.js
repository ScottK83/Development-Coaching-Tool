(function () {
    ...
    function buildCenterRankings() {
        ...
        // Prefer real (non-auto-generated) YTD uploads first, then fall back
        // to the period with the most employees.
        var bestPeriod = null;
        var bestCount = 0;
        var bestSource = '';
        var bestKey = '';
        ...
        // Check YTD data first — prefer real (non-auto-generated) YTD uploads
        Object.entries(yData).forEach(function (entry) {
            ...
            var isRealYtd = !meta.autoGeneratedYtd;

            // If we already found a real YTD, only consider other real YTDs with more employees
            if (foundRealYtd && !isRealYtd) return;

            // A real YTD always beats an auto-generated one, regardless of count
            if (isRealYtd && !foundRealYtd) {
                foundRealYtd = true;
                bestPeriod = period;
                bestCount = count;
